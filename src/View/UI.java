...
public class UI extends Application {
    ...
    private void showAddBirdDialog() {
        ...
        numberLabel.setText("Bird number");
        ...
        gridPane.add(birthdayDate, 1, 2);

        Label rationLabel = new Label();
        rationLabel.setText("Ration type:");
        gridPane.add(rationLabel, 0, 3);

        TextField birdRation = new TextField();
        birdRation.setPromptText("Bird ration");
        gridPane.add(birdRation, 1, 3);

        Button addBtn = new Button();
        addBtn.setText("Add bird");
        addBtn.setOnAction(event -> {
            if (birdNumber.getText().isEmpty() | birdName.getText().isEmpty() | birdRation.getText().isEmpty()) {
        ...
        addBirdStage.setMinHeight(400);
        addBirdStage.setMinWidth(400);
